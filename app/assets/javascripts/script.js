	...
	if (plugins.calendar.length) {
		for (i = 0; i < plugins.calendar.length; i++) {
			...
			calendarItem.rdCalendar({
				...
				month: calendarItem.attr("data-months") ? c.attr("data-months").split(/\s?,\s?/i) : ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro']
			});
		}
	}
