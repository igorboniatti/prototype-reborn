...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { conteudo: @comentario.conteudo, data: @comentario.data, publicacao_id: @comentario.publicacao_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { conteudo: @comentario.conteudo, data: @comentario.data, publicacao_id: @comentario.publicacao_id } }
